defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    ...
    hook_allow_shell_hooks = Keyword.get(config, :hook_allow_shell_hooks)
  ...
  defp hooks_yaml(nil, nil, nil, nil, timeout_ms, allow_shell_hooks) do
    "hooks:\n  timeout_ms: #{yaml_value(timeout_ms)}\n  allow_shell_hooks: #{yaml_value(allow_shell_hooks)}"
  end

  defp hooks_yaml(hook_after_create, hook_before_run, hook_after_run, hook_before_remove, timeout_ms, allow_shell_hooks) do
    [
      "hooks:",
      "  timeout_ms: #{yaml_value(timeout_ms)}",
      "  allow_shell_hooks: #{yaml_value(allow_shell_hooks)}",
